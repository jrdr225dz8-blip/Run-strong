const CACHE="run-strong-recovery-v8b-unique-js";
const ASSETS=["./","./index.html","./styles-v3.css?v=20260815-3","./app-v8.js?v=20260815-8b","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
