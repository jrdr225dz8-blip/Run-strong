const CACHE="run-strong-goals-v9";
const ASSETS=["./","./index.html","./styles-v3.css?v=20260815-3","./app-v9.js?v=20260815-9","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
