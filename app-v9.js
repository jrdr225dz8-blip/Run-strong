...
const BUILD="goals-progressive-v9";
...
const EX={
 ...
 squeeze:E("Svend_Press","Dumbbell Squeeze Press",3,10,15,60,"Chest • inner pec emphasis",["Press dumbbells together.","Keep tension through the whole rep.","Use controlled tempo."]),
 declinepush:E("Decline_Push-Up","Feet-Elevated Push-Up",3,8,15,60,"Upper chest • triceps",["Keep body rigid.","Lower under control.","Stop before shoulders roll forward."]),
 widepush:E("Wide-Grip_Push-Up","Wide Push-Up",2,10,20,30,"Chest finisher",["Hands slightly wider than shoulders.","Keep elbows controlled.","Stop at technical failure."]),
 pullover:E("Dumbbell_Pullover","Dumbbell Pullover",3,10,15,75,"Lats • chest",["Keep ribs down.","Lower only as far as shoulders allow.","Pull weight back over chest."]),
 chestrow:E("Dumbbell_Incline_Row","Chest-Supported Dumbbell Row",3,8,12,75,"Upper back • lats",["Keep chest on bench.","Pull elbows back.","Pause at the top."]),
 yraise:E("Incline_Dumbbell_Y-Raise","Incline Y-Raise",3,12,15,60,"Lower traps • shoulders",["Use light weight.","Reach in a Y shape.","Avoid shrugging."]),
 arnold:E("Arnold_Dumbbell_Press","Arnold Press",3,8,12,75,"Shoulders • triceps",["Rotate smoothly.","Keep ribs stacked.","Do not force range."]),
 zottman:E("Zottman_Curl","Zottman Curl",3,10,12,60,"Biceps • forearms",["Curl palms up.","Rotate at the top.","Lower palms down slowly."]),
 concentration:E("Concentration_Curls","Concentration Curl",3,10,15,60,"Biceps",["Brace elbow against thigh.","Use full range.","Avoid swinging."]),
 kickback:E("Tricep_Dumbbell_Kickback","Dumbbell Triceps Kickback",3,12,15,60,"Triceps",["Upper arm stays still.","Fully extend elbow.","Use light controlled reps."]),
 diamond:E("Diamond_Push-Ups","Diamond Push-Up",3,8,15,60,"Triceps • chest",["Keep hands close.","Keep body rigid.","Scale on knees if needed."]),
 stepup:E("Dumbbell_Step_Ups","Dumbbell Step-Up",3,8,12,75,"Quads • glutes • VMO",["Drive through working leg.","Control the descent.","Keep knee tracking over toes."]),
 stepdown:E("Single_Leg_Squat","Controlled Step-Down",3,8,12,60,"Quads • VMO • knee control",["Lower slowly.","Keep pelvis level.","Knee tracks over middle toes."]),
 wall:E("Wall_Squat","Wall Sit",3,30,60,60,"Quads • isometric",["Back stays supported.","Keep whole foot down.","Hold only pain-free depth."]),
 singleRDL:E("Single_Leg_Deadlift","Single-Leg RDL",3,8,12,75,"Hamstrings • glutes • balance",["Square the hips.","Reach long behind you.","Keep standing knee soft."]),
 bridge:E("Butt_Lift_Bridge","Glute Bridge",3,12,20,60,"Glutes • posterior chain",["Ribs down.","Drive through heels.","Pause at top."]),
 reversecrunch:E("Reverse_Crunch","Reverse Crunch",3,12,20,30,"Lower abs",["Curl pelvis toward ribs.","Avoid swinging.","Lower slowly."]),
 russian:E("Russian_Twist","Weighted Russian Twist",3,16,24,30,"Obliques",["Rotate through torso.","Keep chest tall.","Move under control."]),
 hollow:E("Hollow-Hold","Hollow Body Hold",3,20,40,30,"Abs • anti-extension",["Press low back down.","Shorten lever if needed.","Breathe behind the brace."]),
 climber:E("Mountain_Climbers","Mountain Climbers",3,30,45,30,"Abs • conditioning",["Keep hips level.","Drive knees under torso.","Stay controlled."]),
 suitcase:E("Farmers_Walk","Suitcase Carry",3,30,45,45,"Obliques • trunk stability",["Carry weight on one side.","Stay tall.","Do not lean toward weight."]),
 scap:E("Scapular_Pull-Up","Scapular Pull-Up",2,8,12,20,"Warm-up • shoulders • back",["Keep elbows straight.","Move shoulder blades only.","Use a small controlled range."]),
};

const WORKOUTS={
 runner_push:{name:"Quads + Push",cat:"program",duration:"55–70 min",desc:"Runner-friendly quad/VMO and push strength. Built to add muscle without turning every lift into a leg-destroying session.",xs:[EX.armcircles,EX.squat,EX.incline,EX.bulgarian,EX.lateral,EX.calf,EX.pushup,EX.plank]},
 runner_posterior:{name:"Posterior + Back",cat:"program",duration:"55–70 min",desc:"Hamstrings, glutes, back, soleus and trunk strength for running durability and a stronger back.",xs:[EX.hamstretch,EX.rdl,EX.pullup,EX.hip,EX.onerow,EX.seatedcalf,EX.rear,EX.deadbug]},
 runner_full:{name:"Athletic Full Body",cat:"program",duration:"55–70 min",desc:"Balanced athletic strength with single-leg work, calves, shins, upper body and trunk.",xs:[EX.jumping,EX.lunge,EX.ohp,EX.calf,EX.onerow,EX.goblet,EX.pushup,EX.tib,EX.lateral,EX.plank]},

 chest:{name:"Chest",cat:"muscle",duration:"55–70 min",desc:"Dedicated chest hypertrophy: heavy press, upper chest, stretch work, squeeze work and a push-up finisher.",xs:[EX.armcircles,EX.scap,EX.bench,EX.incline,EX.fly,EX.squeeze,EX.closebench,EX.pullover,EX.pushup,EX.declinepush,EX.widepush]},
 back:{name:"Back",cat:"muscle",duration:"60–75 min",desc:"Lats, mid-back, rear delts and traps for a stronger, wider-looking back and better running posture.",xs:[EX.armcircles,EX.scap,EX.row,EX.pullup,EX.onerow,EX.chestrow,EX.invrow,EX.pullover,EX.rear,EX.yraise,EX.shrug]},
 shoulders:{name:"Shoulders",cat:"muscle",duration:"55–70 min",desc:"Shoulder width and shape with pressing plus side/rear-delt volume.",xs:[EX.armcircles,EX.scap,EX.ohp,EX.arnold,EX.lateral,EX.front,EX.rear,EX.yraise,EX.pushup]},
 arms:{name:"Arms",cat:"muscle",duration:"55–70 min",desc:"High-quality biceps and triceps volume for visibly built arms.",xs:[EX.armcircles,EX.curl,EX.closebench,EX.hammer,EX.tricepext,EX.inclinecurl,EX.benchdip,EX.zottman,EX.kickback,EX.concentration,EX.diamond]},
 biceps:{name:"Biceps",cat:"muscle",duration:"50–65 min",desc:"Biceps and forearm-focused session using multiple curl angles plus pulling.",xs:[EX.armcircles,EX.curl,EX.hammer,EX.inclinecurl,EX.zottman,EX.concentration,EX.onerow,EX.pullup]},
 triceps:{name:"Triceps",cat:"muscle",duration:"50–65 min",desc:"Heavy pressing plus long-head and lockout-focused triceps work.",xs:[EX.armcircles,EX.closebench,EX.tricepext,EX.benchdip,EX.kickback,EX.diamond,EX.pushup,EX.ohp]},
 legs:{name:"Legs",cat:"muscle",duration:"65–80 min",desc:"Complete lower-body development with extra runner durability: quads, VMO, hamstrings, glutes, calves and shins.",xs:[EX.hamstretch,EX.squat,EX.rdl,EX.bulgarian,EX.stepup,EX.stepdown,EX.hip,EX.singleRDL,EX.calf,EX.seatedcalf,EX.tib]},
 quads:{name:"Quads + VMO",cat:"muscle",duration:"55–70 min",desc:"Quad-focused session with deliberate knee-dominant and single-leg work for the teardrop area above the knee.",xs:[EX.jumping,EX.squat,EX.goblet,EX.bulgarian,EX.stepup,EX.stepdown,EX.lunge,EX.wall,EX.calf]},
 posterior:{name:"Hamstrings + Glutes",cat:"muscle",duration:"55–70 min",desc:"Posterior-chain strength and muscle with bilateral and single-leg hinges plus hip extension.",xs:[EX.hamstretch,EX.rdl,EX.stiff,EX.hip,EX.singleRDL,EX.bridge,EX.lunge,EX.seatedcalf,EX.calf]},
 calves:{name:"Calves + Achilles",cat:"muscle",duration:"40–50 min",desc:"Straight-knee calf, soleus, shin and lower-leg capacity work for running durability.",xs:[EX.calf,EX.seatedcalf,EX.tib,EX.stepup,EX.lunge,EX.singleRDL,EX.wall]},
 abs:{name:"Abs + Core",cat:"muscle",duration:"45–60 min",desc:"A complete ab session: flexion, lower abs, obliques, anti-extension and loaded trunk stability.",xs:[EX.crunch,EX.legraise,EX.reversecrunch,EX.russian,EX.plank,EX.sideplank,EX.deadbug,EX.suitcase,EX.bike,EX.hollow,EX.climber]},
 upper:{name:"Upper Body",cat:"program",duration:"60–75 min",desc:"Chest, back, shoulders and arms with enough volume to build the upper body while preserving lower-body recovery.",xs:[EX.armcircles,EX.bench,EX.row,EX.incline,EX.pullup,EX.ohp,EX.chestrow,EX.lateral,EX.rear,EX.hammer,EX.tricepext]},
 lower:{name:"Lower Body",cat:"program",duration:"60–75 min",desc:"Balanced lower-body strength with quad/VMO, posterior chain, calves and shin work.",xs:[EX.hamstretch,EX.squat,EX.rdl,EX.bulgarian,EX.stepup,EX.stepdown,EX.hip,EX.singleRDL,EX.calf,EX.seatedcalf,EX.tib]}
}
...
const BLOCKS={
 ...
 chest:[
  {label:"WARM-UP",kind:"warmup",rest:0,ids:["Arm_Circles","Scapular_Pull-Up"]},
  {label:"A",kind:"solo",rest:120,ids:["Dumbbell_Bench_Press"]},
  {label:"B",kind:"superset",rest:90,ids:["Incline_Dumbbell_Press","Dumbbell_Flyes"]},
  {label:"C",kind:"superset",rest:75,ids:["Svend_Press","Dumbbell_Pullover"]},
  {label:"D",kind:"superset",rest:75,ids:["Close-Grip_Barbell_Bench_Press","Decline_Push-Up"]},
  {label:"FINISHER",kind:"circuit",rest:45,ids:["Pushups","Wide-Grip_Push-Up"]}
 ],
 back:[
  {label:"WARM-UP",kind:"warmup",rest:0,ids:["Arm_Circles","Scapular_Pull-Up"]},
  {label:"A",kind:"solo",rest:120,ids:["Bent_Over_Barbell_Row"]},
  {label:"B",kind:"superset",rest:90,ids:["Pullups","One-Arm_Dumbbell_Row"]},
  {label:"C",kind:"superset",rest:75,ids:["Dumbbell_Incline_Row","Inverted_Row"]},
  {label:"D",kind:"superset",rest:75,ids:["Dumbbell_Pullover","Bent_Over_Dumbbell_Rear_Delt_Raise_With_Head_On_Bench"]},
  {label:"E",kind:"superset",rest:60,ids:["Incline_Dumbbell_Y-Raise","Dumbbell_Shrug"]}
 ],
 shoulders:[
  {label:"WARM-UP",kind:"warmup",rest:0,ids:["Arm_Circles","Scapular_Pull-Up"]},
  {label:"A",kind:"solo",rest:105,ids:["Dumbbell_Shoulder_Press"]},
  {label:"B",kind:"superset",rest:75,ids:["Arnold_Dumbbell_Press","Side_Lateral_Raise"]},
  {label:"C",kind:"superset",rest:60,ids:["Front_Dumbbell_Raise","Bent_Over_Dumbbell_Rear_Delt_Raise_With_Head_On_Bench"]},
  {label:"D",kind:"superset",rest:60,ids:["Incline_Dumbbell_Y-Raise","Pushups"]}
 ],
 arms:[
  {label:"WARM-UP",kind:"warmup",rest:0,ids:["Arm_Circles"]},
  ...
  {label:"D",kind:"superset",rest:60,ids:["Zottman_Curl","Tricep_Dumbbell_Kickback"]},
  {label:"FINISHER",kind:"superset",rest:45,ids:["Concentration_Curls","Diamond_Push-Ups"]}
 ],
 biceps:[
  {label:"WARM-UP",kind:"warmup",rest:0,ids:["Arm_Circles"]},
  ...
  {label:"C",kind:"superset",rest:60,ids:["Zottman_Curl","Concentration_Curls"]},
  {label:"D",kind:"superset",rest:75,ids:["One-Arm_Dumbbell_Row","Pullups"]}
 ],
 triceps:[
  {label:"WARM-UP",kind:"warmup",rest:0,ids:["Arm_Circles"]},
  ...
  {label:"C",kind:"superset",rest:60,ids:["Tricep_Dumbbell_Kickback","Diamond_Push-Ups"]},
  {label:"D",kind:"superset",rest:60,ids:["Pushups","Dumbbell_Shoulder_Press"]}
 ],
 legs:[
  {label:"WARM-UP",kind:"warmup",rest:0,ids:["90_90_Hamstring"]},
  {label:"A",kind:"solo",rest:120,ids:["Barbell_Squat"]},
  {label:"B",kind:"superset",rest:105,ids:["Romanian_Deadlift","Split_Squat_with_Dumbbells"]},
  {label:"C",kind:"superset",rest:90,ids:["Dumbbell_Step_Ups","Single_Leg_Squat"]},
  {label:"D",kind:"superset",rest:90,ids:["Barbell_Hip_Thrust","Single_Leg_Deadlift"]},
  {label:"E",kind:"circuit",rest:60,ids:["Standing_Calf_Raises","Seated_Calf_Raise","Dorsiflexion"]}
 ],
 quads:[
  {label:"WARM-UP",kind:"warmup",rest:0,ids:["Star_Jump"]},
  {label:"A",kind:"solo",rest:120,ids:["Barbell_Squat"]},
  {label:"B",kind:"superset",rest:90,ids:["Goblet_Squat","Split_Squat_with_Dumbbells"]},
  {label:"C",kind:"superset",rest:75,ids:["Dumbbell_Step_Ups","Single_Leg_Squat"]},
  {label:"D",kind:"superset",rest:75,ids:["Dumbbell_Lunges","Wall_Squat"]},
  {label:"E",kind:"solo",rest:60,ids:["Standing_Calf_Raises"]}
 ],
 posterior:[
  {label:"WARM-UP",kind:"warmup",rest:0,ids:["90_90_Hamstring"]},
  {label:"A",kind:"solo",rest:120,ids:["Romanian_Deadlift"]},
  {label:"B",kind:"superset",rest:90,ids:["Stiff-Legged_Barbell_Deadlift","Barbell_Hip_Thrust"]},
  {label:"C",kind:"superset",rest:75,ids:["Single_Leg_Deadlift","Butt_Lift_Bridge"]},
  {label:"D",kind:"superset",rest:75,ids:["Dumbbell_Lunges","Seated_Calf_Raise"]},
  {label:"E",kind:"solo",rest:60,ids:["Standing_Calf_Raises"]}
 ],
 calves:[
  {label:"A",kind:"superset",rest:60,ids:["Standing_Calf_Raises","Seated_Calf_Raise"]},
  {label:"B",kind:"superset",rest:60,ids:["Dorsiflexion","Dumbbell_Step_Ups"]},
  {label:"C",kind:"superset",rest:60,ids:["Dumbbell_Lunges","Single_Leg_Deadlift"]},
  {label:"D",kind:"solo",rest:60,ids:["Wall_Squat"]}
 ],
 abs:[
  {label:"A",kind:"superset",rest:45,ids:["Crunches","Flat_Bench_Lying_Leg_Raise"]},
  {label:"B",kind:"superset",rest:45,ids:["Reverse_Crunch","Russian_Twist"]},
  {label:"C",kind:"circuit",rest:45,ids:["Plank","Dead_Bug","Side_Bridge"]},
  {label:"D",kind:"circuit",rest:45,ids:["Farmers_Walk","Air_Bike","Hollow-Hold"]},
  {label:"FINISHER",kind:"circuit",rest:45,ids:["Mountain_Climbers","Reverse_Crunch","Plank"]}
 ],
 upper:[
  {label:"WARM-UP",kind:"warmup",rest:0,ids:["Arm_Circles"]},
  {label:"A",kind:"superset",rest:90,ids:["Dumbbell_Bench_Press","Bent_Over_Barbell_Row"]},
  {label:"B",kind:"superset",rest:90,ids:["Incline_Dumbbell_Press","Pullups"]},
  {label:"C",kind:"superset",rest:75,ids:["Dumbbell_Shoulder_Press","Dumbbell_Incline_Row"]},
  {label:"D",kind:"superset",rest:60,ids:["Side_Lateral_Raise","Bent_Over_Dumbbell_Rear_Delt_Raise_With_Head_On_Bench"]},
  {label:"E",kind:"superset",rest:60,ids:["Alternate_Hammer_Curl","Standing_Dumbbell_Triceps_Extension"]}
 ],
 lower:[
  {label:"WARM-UP",kind:"warmup",rest:0,ids:["90_90_Hamstring"]},
  {label:"A",kind:"solo",rest:120,ids:["Barbell_Squat"]},
...
function workoutDetail(id){
 ...
 ${id!=="abs"?`<section class="exercise-card"><div class="exercise-top"><b>ABS</b><div><b>${abFinisherForDate().name}</b><small>3 rounds • automatically starts after lifting</small></div><span class="arrow">›</span></div></section>`:""}
...
const AB_FINISHERS=[
 {name:"ABS A — Upper + Lower",rounds:3,rest:45,items:[EX.crunch,EX.legraise,EX.reversecrunch,EX.plank]},
 {name:"ABS B — Stability + Obliques",rounds:3,rest:45,items:[EX.russian,EX.deadbug,EX.sideplank,EX.suitcase]},
 {name:"ABS C — Brutal Finisher",rounds:3,rest:60,items:[EX.bike,EX.legraise,EX.climber,EX.hollow,EX.plank]}
];
function abFinisherForDate(){
 const week=Math.floor(Date.now()/(7*86400000));
 return AB_FINISHERS[week%AB_FINISHERS.length];
}
function appendAbFinisher(steps,id){
 if(id==="abs") return steps;
 const f=abFinisherForDate();
 for(let round=1;round<=f.rounds;round++){
  f.items.forEach((x,idx)=>{
   steps.push({x,block:f.name,kind:"circuit",set:round,totalSets:f.rounds,rest:idx===f.items.length-1?f.rest:0,lastInRound:idx===f.items.length-1,isAbsFinisher:true});
  });
 }
 return steps;
}
...
function startGuided(id,w){
 guided={id,w,steps:appendAbFinisher(buildGuidedSteps(id,w),id),i:0};
 renderGuided();
}
...
function priorExerciseSets(exerciseId,currentKey){
 const entries=Object.entries(state.sessions)
  .filter(([k,v])=>k!==currentKey && v && Array.isArray(v[exerciseId]) && v[exerciseId].length)
  .sort((a,b)=>a[0].localeCompare(b[0]));
 if(!entries.length)return null;
 return entries[entries.length-1][1][exerciseId];
}
function progressionAdvice(x){
 const key=new Date().toISOString().slice(0,10)+"-"+guided.id;
 const prior=priorExerciseSets(x.id,key);
 if(!prior)return {last:"No previous session",target:`Start with a weight you can control for ${x.min}–${x.max} reps.`};
 const valid=prior.map(s=>({w:parseFloat(s.weight),r:parseInt(s.reps)})).filter(s=>Number.isFinite(s.r));
 if(!valid.length)return {last:"Previous set logged",target:`Aim for ${x.min}–${x.max} clean reps.`};
 const last=valid[valid.length-1], allTop=valid.length>=x.sets && valid.slice(-x.sets).every(s=>s.r>=x.max);
 const sameWeight=valid.filter(s=>Number.isFinite(s.w)).map(s=>s.w);
 let target;
 if(allTop && Number.isFinite(last.w)) target=`You hit the top of the range. Increase weight slightly and aim for ${x.min}+ reps.`;
 else if(Number.isFinite(last.w)) target=`Keep ${last.w} lb and beat last time by 1–2 total reps before adding weight.`;
 else target=`Beat last time by 1–2 total reps with clean form.`;
 return {last:`${Number.isFinite(last.w)?last.w+" lb • ":""}${last.r} reps on last logged set`,target};
}
...
function renderGuided(){
 ...
 ${st.kind==="warmup"||st.isAbsFinisher?"":(()=>{const p=progressionAdvice(x);return `<div class="next" style="margin-top:12px"><b>PROGRESSIVE OVERLOAD</b><br><span class="muted">LAST:</span> ${p.last}<br><span class="muted">TODAY:</span> ${p.target}</div>`})()}
...
const RECOVERY_ROUTINES={
 quick:{
  name:"Quick Recovery",
  duration:"5 min",
  subtitle:"Post-run / post-lift reset",
  items:[
   {x:EX.quadstretch,mode:"time",value:30,label:"30 sec/side"},
   {x:EX.hamstretch,mode:"reps",value:8,label:"8 reps/side"},
   {x:EX.seatedcalf,mode:"time",value:30,label:"30 sec/side"},
   {x:EX.calf,mode:"time",value:30,label:"30 sec/side"},
   {x:EX.deadbug,mode:"reps",value:6,label:"6 reps/side"}
  ]
 },
 full:{
  name:"Full Recovery",
  duration:"12–15 min",
  subtitle:"Deeper runner recovery session",
  items:[
   {x:EX.hamstretch,mode:"reps",value:8,label:"8 reps/side"},
   {x:EX.quadstretch,mode:"time",value:45,label:"45 sec/side"},
   {x:EX.seatedcalf,mode:"time",value:45,label:"45 sec/side"},
   {x:EX.calf,mode:"time",value:45,label:"45 sec/side"},
   {x:EX.tib,mode:"reps",value:20,label:"2 × 20"},
   {x:EX.seatedcalf,mode:"reps",value:15,label:"2 × 15"},
   {x:EX.calf,mode:"reps",value:15,label:"2 × 15"},
   {x:EX.hip,mode:"reps",value:15,label:"2 × 15"},
   {x:EX.deadbug,mode:"reps",value:8,label:"8 reps/side"}
  ]
 }
};
let recoveryGuide=null;

function startRecoveryRoutine(key){
 const r=RECOVERY_ROUTINES[key];
 recoveryGuide={key,r,i:0};
 renderRecoveryGuide();
}
function renderRecoveryGuide(){
 const g=recoveryGuide;
 const item=g.r.items[g.i];
 if(!item){finishRecoveryRoutine();return}
 const x=item.x;
 const pct=Math.round((g.i/g.r.items.length)*100);
 app.innerHTML=`<div class="guided-top">
  <button class="secondary" id="exitRecovery">×</button>
  <div class="pbar"><span style="width:${pct}%"></span></div>
  <span class="muted">${g.i+1}/${g.r.items.length}</span>
 </div>
 <section class="exercise-detail">
  <div class="kicker">${g.r.name.toUpperCase()}</div>
  <h1>${x.name}</h1>
  <div class="big-target">${item.label}</div>
  <div class="muted">${x.meta}</div>
  <button class="secondary video" id="recoveryVideo">▶ Watch video example</button>
  <div class="guide-photo">
    <img src="${x.img0}" onerror="this.src='${EX.pushup.img0}'">
    <img src="${x.img1}" onerror="this.src='${EX.pushup.img1}'">
  </div>
  <div class="guide-labels"><span>START</span><span>FINISH</span></div>
  <div class="cues">${x.cues.map(c=>`<div class="cue">✓ ${c}</div>`).join("")}</div>
  ${item.mode==="time"
    ? `<button class="secondary" style="width:100%;margin-top:14px" id="startRecoveryTimer">Start ${item.value}s timer</button>`
    : `<div class="next"><b>REPS</b><br>Complete ${item.label} with slow, controlled form.</div>`}
  <div class="actions" style="margin-top:14px">
    ${g.i>0?`<button class="secondary" id="prevRecovery">← Previous</button>`:""}
    <button class="primary" id="nextRecovery">${g.i===g.r.items.length-1?"Finish routine":"Next →"}</button>
  </div>
 </section>`;
 document.getElementById("exitRecovery").onclick=()=>{recoveryGuide=null;renderRecovery()};
 document.getElementById("recoveryVideo").onclick=()=>window.open(`https://www.youtube.com/results?search_query=${encodeURIComponent(x.name+" exercise tutorial")}`,"_blank");
 if(g.i>0) document.getElementById("prevRecovery").onclick=()=>{g.i--;renderRecoveryGuide()};
 document.getElementById("nextRecovery").onclick=()=>{g.i++;renderRecoveryGuide()};
 const timerBtn=document.getElementById("startRecoveryTimer");
 if(timerBtn) timerBtn.onclick=()=>runRecoveryTimer(item.value);
}
function runRecoveryTimer(sec){
 let r=sec;
 app.innerHTML=`<section class="rest-screen"><div class="kicker">RECOVERY TIMER</div><div class="rest-time" id="recoveryTimer">${r}</div><h2>Stay relaxed and breathe normally.</h2><button class="secondary" id="skipRecoveryTimer">Finish early</button></section>`;
 const t=setInterval(()=>{
  r--;
  const el=document.getElementById("recoveryTimer");
  if(el) el.textContent=r;
  if(r<=0){clearInterval(t);recoveryGuide.i++;renderRecoveryGuide()}
 },1000);
 document.getElementById("skipRecoveryTimer").onclick=()=>{clearInterval(t);recoveryGuide.i++;renderRecoveryGuide()};
}
function finishRecoveryRoutine(){
 state.logs.unshift({date:new Date().toISOString(),name:recoveryGuide.r.name,type:"recovery"});
 save();
 const title=recoveryGuide.r.name;
 recoveryGuide=null;
 app.innerHTML=`<section class="rest-screen"><div class="rest-time" style="color:#fff">✓</div><h1>${title} complete</h1><div class="quote">Recovery done. Keep the next run easy if your legs still feel beat up.</div><button class="primary" id="doneRecovery">Done</button></section>`;
 document.getElementById("doneRecovery").onclick=()=>renderRecovery();
}

function renderRecovery(){
 app.innerHTML=`
 <div class="section-head"><h3>RECOVERY ROUTINES</h3></div>
 <div class="library-grid">
  <button class="library-card recovery-start-card" data-routine="quick">
   <div><strong>⚡ Quick Recovery</strong><small>5 min • post-run / post-lift reset</small></div><span class="arrow">›</span>
  </button>
  <button class="library-card recovery-start-card" data-routine="full">
   <div><strong>✦ Full Recovery</strong><small>12–15 min • deeper runner recovery</small></div><span class="arrow">›</span>
  </button>
 </div>

 <div class="section-head"><h3>RECOVERY LIBRARY</h3></div>
 ${[EX.quadstretch,EX.hamstretch,EX.seatedcalf,EX.calf,EX.tib,EX.hip,EX.deadbug].map(x=>`
 <button class="exercise-card recovery-lib-card" data-x="${x.id}" style="width:100%;text-align:left;color:white">
   <div class="exercise-top"><div></div><div><b>${x.name}</b><small>${x.meta}</small></div><span class="arrow">›</span></div>
   <div class="thumbs"><img src="${x.img0}" onerror="this.src='${EX.pushup.img0}'"><img src="${x.img1}" onerror="this.src='${EX.pushup.img1}'"></div>
 </button>`).join("")}
 <div class="recovery-card"><b>Easy walk</b><br><small>10–20 min, conversational effort</small></div>
 <div class="recovery-card"><b>Sleep + fueling</b><br><small>Still your biggest recovery levers.</small></div>`;

 document.querySelectorAll(".recovery-start-card").forEach(b=>b.onclick=()=>startRecoveryRoutine(b.dataset.routine));
 document.querySelectorAll(".recovery-lib-card").forEach(b=>b.onclick=()=>{
   const x=Object.values(EX).find(v=>v.id===b.dataset.x);
   if(!x)return;
   app.innerHTML=`<button class="secondary" id="backRecovery">← Recovery</button><div style="height:12px"></div>
   <section class="exercise-detail"><h1>${x.name}</h1><div class="muted">${x.meta}</div>
   <button class="secondary video" id="singleRecoveryVideo">▶ Watch video example</button>
   <div class="guide-photo"><img src="${x.img0}" onerror="this.src='${EX.pushup.img0}'"><img src="${x.img1}" onerror="this.src='${EX.pushup.img1}'"></div>
   <div class="guide-labels"><span>START</span><span>FINISH</span></div>
   <div class="cues">${x.cues.map(c=>`<div class="cue">✓ ${c}</div>`).join("")}</div></section>`;
   document.getElementById("backRecovery").onclick=()=>renderRecovery();
   document.getElementById("singleRecoveryVideo").onclick=()=>window.open(`https://www.youtube.com/results?search_query=${encodeURIComponent(x.name+" exercise tutorial")}`,"_blank");
 });
}
